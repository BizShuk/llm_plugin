...
| `config/`  | Configuration loading and client initialization |
...
- **Default SDK**: `github.com/spf13/cobra`
- **Responsibility**: CLI entry points that run handlers and services. Acts as an extension of the main function.
- **Structure**: Sub-commands are organized by domain. Use flags and switch statements to run specific modules.
